...
from app.utils.common_utils import phone_format, add_date_str
...
def global_init(template_folder: str, auto_reload: bool = False, cache_init: bool = True):
    ...
    __templates = Jinja2Templates(directory=template_folder, extensions=["jinja2.ext.loopcontrols"])
    __templates.env.auto_reload = auto_reload
    __templates.env.filters["phone_format"] = phone_format
    __templates.env.filters["add_date_str"] = add_date_str
